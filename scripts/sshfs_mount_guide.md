...
# 挂载
sshfs root@YOUR_SERVER_IP:/root/github/stock-quant/python/data ~/mnt/stock-server
...
# 1. 挂载（如果未挂载）
mountpoint -q ~/mnt/stock-server || sshfs root@SERVER_IP:/root/github/stock-quant/python/data ~/mnt/stock-server
