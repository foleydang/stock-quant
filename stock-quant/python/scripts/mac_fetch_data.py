...
print("\n传输方式（任选）：")
print("  scp ~/Downloads/north_flow.csv ~/Downloads/stock_sector.csv ~/Downloads/hs300_daily.csv root@47.242.158.242:/root/github/stock-quant/stock-quant/python/data/")
print("  或用其他方式传上去")
print("\n服务器导入命令：")
print("  python3 /root/github/stock-quant/stock-quant/python/scripts/import_csv_data.py")