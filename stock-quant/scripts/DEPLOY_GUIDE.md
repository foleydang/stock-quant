...
编辑 `/root/github/stock-quant/stock-quant/python/data/data_handler.py`：
...
```bash
*/30 9-15 * * 1-5 /root/github/stock-quant/stock-quant/scripts/start.sh monitor
0 20 * * 1-5 /root/github/stock-quant/stock-quant/scripts/start.sh update
```
